(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_64d50a00abc90752fc28204a")
...
_mrmcp['stat_host'] = 'https://64d50a00abc90752fc28204a.stat.mugeda.com/stats/c.gif';
_mrmcp['track_bot'] = 'http://cd.mugeda.com/media/pages/track/track_20131030.html';
_mrmcp['wechat_thumb_scheme'] = '';
_mrmcp['data_server'] = "https://weika.mugeda.com";
_mrmcp['customer_visitor_tailor_uid'] = "";
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.11.92';
...
if(!window['_mrmcp']['loader']){
    var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['default']({
        'loadInfo': {"style":"default","textLoading":0,"messageText":"","messageSize":12,"messageColor":"#FFF","progressColor":"#F36523","progressBackground":"#FFF","backgroundColor":"#000","progressPosition":"20","logoWidth":128},
        'thisAni': {
            'dom': null,
            'width': 320
        },
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1692142071061", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1692142071061" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
